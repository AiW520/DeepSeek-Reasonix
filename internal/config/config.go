...
type ProviderEntry struct {
	...
	FallbackModels           []string          `toml:"fallback_models"`             // ordered models used only before the primary emits output
	FirstTokenTimeoutSeconds int               `toml:"first_token_timeout_seconds"` // zero uses the runtime default when fallback_models is set
